...
namespace Org.BouncyCastle.Crypto.Xml
{
    public static class CryptoHelpers
    {
        ...
        private static readonly Dictionary<String, Func<Object>> _knownNames = new Dictionary<String, Func<Object>>()
        {
            ...
            { "http://www.w3.org/2000/09/xmldsig# KeyValue/ECKeyValue", () => new ECKeyValue() },
            ...
            { "http://www.w3.org/2001/04/xmlenc# AgreementMethod", () => new KeyInfoAgreementMethod() },
            { "http://www.w3.org/2009/xmlenc11# KeyDerivationMethod", () => new KeyDerivationMethod() },
            { "http://www.w3.org/2009/xmlenc11# ConcatKDFParams", () => new ConcatKDFParams() },
            ...
            { "http://www.w3.org/2001/04/xmlenc#aes128-gcm", () => new GcmBlockCipher(new RijndaelEngine(128)) },
            { "http://www.w3.org/2001/04/xmlenc#aes192-gcm", () => new GcmBlockCipher(new RijndaelEngine(192)) },
            { "http://www.w3.org/2001/04/xmlenc#aes256-gcm", () => new GcmBlockCipher(new RijndaelEngine(256)) },
            { "http://www.w3.org/2001/04/xmlenc#kw-aes128", () => new Rfc3394WrapEngine(new RijndaelEngine(128)) },
            { "http://www.w3.org/2001/04/xmlenc#kw-aes192", () => new Rfc3394WrapEngine(new RijndaelEngine(192)) },
            { "http://www.w3.org/2001/04/xmlenc#kw-aes256", () => new Rfc3394WrapEngine(new RijndaelEngine(256)) },
            { "http://www.w3.org/2009/xmlenc11#kw-aes-128-pad", () => new Rfc5649WrapEngine(new RijndaelEngine(128)) },
            { "http://www.w3.org/2009/xmlenc11#kw-aes-192-pad", () => new Rfc5649WrapEngine(new RijndaelEngine(192)) },
            { "http://www.w3.org/2009/xmlenc11#kw-aes-256-pad", () => new Rfc5649WrapEngine(new RijndaelEngine(256)) },
            { "http://www.w3.org/2001/04/xmldsig-more#camellia128-cbc", () => new PaddedBufferedBlockCipher(new CbcBlockCipher(new CamelliaEngine()), new Pkcs7Padding()) },
            { "http://www.w3.org/2001/04/xmldsig-more#camellia192-cbc", () => new PaddedBufferedBlockCipher(new CbcBlockCipher(new CamelliaEngine()), new Pkcs7Padding()) },
            { "http://www.w3.org/2001/04/xmldsig-more#camellia256-cbc", () => new PaddedBufferedBlockCipher(new CbcBlockCipher(new CamelliaEngine()), new Pkcs7Padding()) },
            { "http://www.w3.org/2001/04/xmldsig-more#kw-camellia128", () => new Rfc3394WrapEngine(new CamelliaEngine()) },
            { "http://www.w3.org/2001/04/xmldsig-more#kw-camellia192", () => new Rfc3394WrapEngine(new CamelliaEngine()) },
            { "http://www.w3.org/2001/04/xmldsig-more#kw-camellia256", () => new Rfc3394WrapEngine(new CamelliaEngine()) },
        };
